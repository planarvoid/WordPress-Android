...
public class PlayQueueUriTest {
    ...
    private PlaySourceInfo playSourceInfo = new PlaySourceInfo.Builder().originUrl("1").exploreTag("2").recommenderVersion("v1").build();
    private PlaySourceInfo playSourceInfo2 = new PlaySourceInfo.Builder().originUrl("3").exploreTag("4").recommenderVersion("v2").build();
    ...
    public void shouldBuildUri() throws Exception {
        ...
        expect(playQueueUri.toUri(123l, 0, 100l, playSourceInfo).toString())
                .toEqual("content://com.soundcloud.android.provider.ScContentProvider/me/stream?trackId=123&playlistPos=0&seekPos=100&playSource-recommenderVersion=v1&playSource-exploreTag=2&playSource-originUrl=1");
    }
    ...
    public void shouldOverwriteOldParams() throws Exception {
        ...
        expect(newUri.toString()).toEqual("content://com.soundcloud.android.provider.ScContentProvider/me/stream?trackId=456&playlistPos=2&seekPos=400&playSource-recommenderVersion=v2&playSource-exploreTag=4&playSource-originUrl=3");
    }
