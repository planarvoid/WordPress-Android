...
public class PlayQueueUriTest {
    ...
    public void shouldBuildUri() throws Exception {
        ...
        expect(playQueueUri.toUri(new Track(123l), 0, 100l, new TrackingInfo("1","2")).toString()).toEqual("content://com.soundcloud.android.provider.ScContentProvider/me/stream?trackId=123&playlistPos=0&seekPos=100&tracking-sourceContext=1&tracking-exploreTag=2");
    }
    ...
    public void shouldOverwriteOldParams() throws Exception {
        ...
        expect(newUri.toString()).toEqual("content://com.soundcloud.android.provider.ScContentProvider/me/stream?trackId=456&playlistPos=2&seekPos=400&tracking-sourceContext=3&tracking-exploreTag=4");
    }
