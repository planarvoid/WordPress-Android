...
public class SyncOperationsOldTest {

    private SyncOperationsOld<String> syncOps;
    ...
    public void setup() {
        ...
        syncOps = new SyncOperationsOld<String>(Robolectric.application, localStorageOp).subscribeOn(Schedulers.immediate());
    }
