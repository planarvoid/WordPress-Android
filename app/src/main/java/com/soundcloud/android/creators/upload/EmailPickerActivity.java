...
public class EmailPickerActivity extends ListActivity {
        ...
        findViewById(R.id.pick_done).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Uri uri = new Uri.Builder().scheme("content")
                        .authority(EmailPickerActivity.this.getClass().getName()).path(BUNDLE_KEY).build();
    ...
    private static class EmailCursorAdapter extends CursorAdapter {
        ...
        private EmailPickerItemLayout createViewFromResource(Cursor cursor,
            ...
            if (convertView instanceof EmailPickerItemLayout) {
                ...
                view = (EmailPickerItemLayout) mInflater.inflate(R.layout.email_picker_item, parent, false);
            }
