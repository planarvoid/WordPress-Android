...
public class AccessListLayout extends LinearLayout implements View.OnClickListener {
    private Adapter listAdapter;

    @SuppressWarnings({"UnusedDeclaration"})
    public AccessListLayout(Context context) {
        this(context, null);
    }

    @SuppressWarnings({"UnusedDeclaration"})
    public AccessListLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public void onClick(View view) {
        if (getContext() instanceof Activity) {
            ...
            Intent intent = new Intent(getContext(), EmailPickerActivity.class);
            if (accessList != null) {
                EmailPickerItemLayout item = (EmailPickerItemLayout) view;

                intent.putExtra(EmailPickerActivity.BUNDLE_KEY,
                        accessList.toArray(new String[accessList.size()]));
                intent.putExtra(EmailPickerActivity.SELECTED, item.getEmail());
            }
    ...
    private static class Adapter extends BaseAdapter {
        ...
        public View getView(int position, @Nullable View convertView, ViewGroup parent) {
            ...
            EmailPickerItemLayout view;
            if (convertView instanceof EmailPickerItemLayout) {
                view = (EmailPickerItemLayout) convertView;
            } else {
                view = (EmailPickerItemLayout)
