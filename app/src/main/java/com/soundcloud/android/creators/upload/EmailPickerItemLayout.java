...
public class EmailPickerItemLayout extends RelativeLayout {
    private TextView mName, mEmail;
    private ImageView mIcon;

    @SuppressWarnings("UnusedDeclaration")
    public EmailPickerItemLayout(Context context) {
        super(context);
    }

    @SuppressWarnings("UnusedDeclaration")
    public EmailPickerItemLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    @SuppressWarnings("UnusedDeclaration")
    public EmailPickerItemLayout(Context context, AttributeSet attrs, int defStyle) {
