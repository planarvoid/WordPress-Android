...
public class Navigator {
    ...
    public void openUpgrade(Activity activity) {
        activity.startActivity(new Intent(activity, featureFlags.isEnabled(Flag.FEATURE_WEB_UPGRADE_FLOW) ? WebConversionActivity.class : NativeConversionActivity.class));
    }
