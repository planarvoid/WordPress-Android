...
import com.soundcloud.android.tracks.NewTrackItemMapper;
...
public class LoadPlaylistTracksCommand extends Command<Urn, List<TrackItem>> {
    ...
    @Override
    public List<TrackItem> call(Urn playlistUrn) {
        return propeller
                .query(getPlaylistTracksQuery(playlistUrn))
                .toList(new NewTrackItemMapper());
    }
