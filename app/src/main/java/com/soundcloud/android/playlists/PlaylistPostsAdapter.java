...
public class PlaylistPostsAdapter extends EndlessAdapter<PropertySet>
        ...
        return new DefaultFragmentLightCycle(){
            ...
            public void onViewCreated(Fragment fragment, View view, @Nullable Bundle savedInstanceState) {
                eventSubscriptions = new CompositeSubscription(
                        eventBus.subscribe(EventQueue.ENTITY_UPDATED, new ListContentSyncedSubscriber(PlaylistPostsAdapter.this))
                );
            }
