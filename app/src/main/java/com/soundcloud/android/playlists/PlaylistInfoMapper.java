...
public class PlaylistInfoMapper extends OfflinePlaylistMapper {
    ...
    public PropertySet map(CursorReader cursorReader) {
        ...
        propertySet.put(PlaylistProperty.PLAYLIST_DURATION, cursorReader.getLong(TableColumns.SoundView.DURATION));
        ...
        propertySet.put(PlaylistProperty.CREATED_AT,
                        cursorReader.getDateFromTimestamp(TableColumns.SoundView.CREATED_AT));
