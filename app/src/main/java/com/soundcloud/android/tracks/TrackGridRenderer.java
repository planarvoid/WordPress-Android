...
public class TrackGridRenderer implements CellRenderer<TrackItem> {
    ...
    public View createItemView(ViewGroup parent) {
        View itemView = View.inflate(parent.getContext(), R.layout.explore_track_card, null);
        ...
        viewHolder.playcount.setCompoundDrawablesWithIntrinsicBounds(R.drawable.inset_stats_plays, 0, 0, 0);
        return itemView;
    }
