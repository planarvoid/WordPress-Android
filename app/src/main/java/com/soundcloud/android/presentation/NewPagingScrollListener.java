...
final class NewPagingScrollListener implements AbsListView.OnScrollListener {

    private final NewListPresenter listPresenter;
    private final PagingItemAdapter<?> adapter;
    private final AbsListView.OnScrollListener listenerDelegate;

    NewPagingScrollListener(NewListPresenter listPresenter, PagingItemAdapter<?> adapter, AbsListView.OnScrollListener listenerDelegate) {
    ...
    public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
        ...
        final NewPager<?, ?> pager = listPresenter.getListBinding().getPager();
