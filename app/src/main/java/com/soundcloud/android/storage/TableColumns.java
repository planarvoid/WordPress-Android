...
public final class TableColumns {
    ...
    public static final class SoundStreamView extends SoundStream {
        ...
        static final String REPOSTER_PERMALINK = "reposter_permalink";
        ...
        static final String SOUND_PERMALINK_URL = "sound_permalink_url";
    }
    ...
    public static final class ActivityView extends Activities {
        ...
        public static final String USER_IS_PRO = "activity_user_is_pro";
    }

    static final class PlaylistTracksView extends SoundView {
        public static final String PLAYLIST_ID = PlaylistTracks.PLAYLIST_ID;
        static final String PLAYLIST_POSITION = "playlist_position";
        static final String PLAYLIST_ADDED_AT = "playlist_added_at";
    }
