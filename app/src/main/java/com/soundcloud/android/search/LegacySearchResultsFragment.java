...
public class LegacySearchResultsFragment extends DefaultFragment
    ...
    @Inject LegacySearchOperations searchOperations;
    @Inject PlaybackOperations playbackOperations;
    @Inject ListViewController listViewController;
    @Inject EventBus eventBus;
    @Inject LegacySearchResultsAdapter adapter;
    ...
    public LegacySearchResultsFragment() {
