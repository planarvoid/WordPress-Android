...
public abstract class RecyclingPagerAdapter extends PagerAdapter {
    ...
    /**
     * Not from the original code. I added this to fix a viewtype bug - JS
     *
     * This will request a view type based on the view itself. This is necessary because as viewtypes by
     * position will change, and the destroy item function needs to get the view type for an outdated position.
     * It needs to be able to do so based on the view itself.
     */
    public abstract int getItemViewTypeFromObject(Object object);
}