...
/**
 * Use {@link UpdateCurrentDownloadSubscriber}
 */
@Deprecated
public class LegacyUpdateCurrentDownloadSubscriber extends DefaultSubscriber<OfflineContentChangedEvent> {
    private final ItemAdapter adapter;

    public LegacyUpdateCurrentDownloadSubscriber(ItemAdapter adapter) {
