...
public final class LegacyEntityListSubscriber extends DefaultSubscriber<EntityStateChangedEvent> {
    private final ItemAdapter<PropertySet> adapter;

    public LegacyEntityListSubscriber(ItemAdapter<PropertySet> adapter) {
