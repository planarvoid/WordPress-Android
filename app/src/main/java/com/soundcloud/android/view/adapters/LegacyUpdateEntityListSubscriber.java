...
/**
 * Use {@link UpdateEntityListSubscriber}
 */
@Deprecated
public final class LegacyUpdateEntityListSubscriber extends DefaultSubscriber<EntityStateChangedEvent> {
    private final ItemAdapter adapter;

    public LegacyUpdateEntityListSubscriber(ItemAdapter adapter) {
