...
import static com.soundcloud.android.storage.Tables.RecentlyPlayed.TABLE;
import static com.soundcloud.android.storage.Tables.RecentlyPlayed.TIMESTAMP;
...
public class OptimizeRecentlyPlayedCommand extends DefaultWriteStorageCommand<Integer, ChangeResult> {
    ...
    @Inject
    OptimizeRecentlyPlayedCommand(PropellerDatabase propeller) {
        super(propeller);
    }
