...
class PlayHistoryCollectionPresenter extends BaseCollectionPresenter {

    private final CollectionOperations collectionOperations;

    PlayHistoryCollectionPresenter(SwipeRefreshAttacher swipeRefreshAttacher,
    ...
    List<CollectionItem> buildCollectionItems(MyCollection myCollection) {
        ...
        List<CollectionItem> collectionItems = new ArrayList<>(playHistoryTrackItems.size() + 4);
