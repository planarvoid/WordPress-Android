...
class RecentlyPlayedProfileRenderer implements CellRenderer<RecentlyPlayedPlayableItem> {
    ...
    private void setImage(View view, ImageResource imageResource) {
        ...
        styledImageView.showWithPlaceholder(imageResource.getImageUrlTemplate(), Optional.of(ImageStyle.CIRCULAR), Optional.of(imageResource.getUrn()), imageOperations);
    }
