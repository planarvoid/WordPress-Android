...
/**
 * @deprecated This is needed for migration but should be removed in the next release
 */
@Deprecated
public class OldPlayQueueStorage {
    ...
    @Inject
    public OldPlayQueueStorage(PropellerRxV2 propellerRx) {
    ...
    @VisibleForTesting
    public Single<TxnResult> store(final PlayQueue playQueue) {
    ...
    public Single<List<PlayQueueItem>> load() {
