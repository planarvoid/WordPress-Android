...
public class SuggestedTrackImageView extends ParallaxImageView {

    private static final double GRADIENT_START_POSITION = .5;
    ...
    public SuggestedTrackImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
