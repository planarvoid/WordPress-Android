...
public class LegacyProfileActivity extends ScActivity implements
    ...
    @Inject PublicApiWrapper oldCloudAPI;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        userImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (user != null) {
                    new FullImageDialog(LegacyProfileActivity.this, user.getUrn(), imageOperations).show();
                }
    ...
    public enum Tab {
        ...
        tracks(Actions.YOUR_SOUNDS, Screen.USER_POSTS, Screen.YOUR_POSTS, Content.USER_SOUNDS, Content.ME_SOUNDS, R.string.tab_title_user_posts),
