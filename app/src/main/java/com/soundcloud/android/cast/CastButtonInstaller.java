...
public class CastButtonInstaller {
    ...
    @Inject
    CastButtonInstaller(CustomMediaRouteDialogFactory customMediaRouteDialogFactory) {
        this.customMediaRouteDialogFactory = customMediaRouteDialogFactory;
    }

    public Optional<MenuItem> addMediaRouteButton(Context context, Menu menu, int itemId) {
        try {
