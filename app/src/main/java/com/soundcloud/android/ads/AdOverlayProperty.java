...
public class AdOverlayProperty {
    ...
    public static final Property<List<String>> TRACKING_IMPRESSION_URLS = Property.of(AdOverlayProperty.class, (Class<List<String>>)(Class<?>) List.class);
    public static final Property<List<String>> TRACKING_CLICK_URLS = Property.of(AdOverlayProperty.class, (Class<List<String>>)(Class<?>) List.class);
