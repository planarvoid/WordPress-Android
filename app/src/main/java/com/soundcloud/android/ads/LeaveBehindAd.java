...
public abstract class LeaveBehindAd extends OverlayAdData {
    ...
    public static LeaveBehindAd create(ApiModel apiModel, Urn audioAdUrn) {
        return new AutoValue_LeaveBehindAd(apiModel.adUrn(),
    ...
    static abstract class ApiModel extends ApiBaseAdVisual {
        ...
        public static ApiModel create(@JsonProperty("urn") Urn urn,
            ...
            return new AutoValue_LeaveBehindAd_ApiModel(urn, imageUrl, clickthroughUrl, trackingImpressionUrls, trackingClickUrls);
        }
    }
}
