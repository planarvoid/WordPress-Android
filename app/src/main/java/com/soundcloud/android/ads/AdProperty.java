...
public class AdProperty {
    public static final Property<String> AD_AUDIO_URN = Property.of(AdProperty.class, String.class);
    public static final Property<String> AD_VISUAL_URN = Property.of(AdProperty.class, String.class);
