...
public class SoundRecorder implements IAudioManager.MusicFocusable, RecordStream.onAmplitudeGenerationListener {
    ...
    public void reset(boolean deleteRecording){
        ...
        if (mRecording != null) {
            if (deleteRecording) RecordingsDAO.delete(mRecording, mContext.getContentResolver());
            mRecording = null;
        }
    }
    ...
    public @Nullable Recording saveState() {
        ...
        if (mRecording != null) {
            ...
            final Uri uri = RecordingsDAO.insert(mRecording, mContext.getContentResolver(), false);
            if (uri != null) {
