...
public class ChangeLikeToSaveExperimentStringHelper {
    ...
    public enum ExperimentString {
        ...
        REMOVE_OFFLINE_CONTENT_BODY_SYNC_COLLECTION(R.string.remove_offline_content_body_sync_collection, R.string.remove_offline_content_body_sync_collection_tracks),
        DISABLE_OFFLINE_COLLECTION_BODY(R.string.disable_offline_collection_body, R.string.disable_offline_collection_body_tracks),
        DISABLE_OFFLINE_COLLECTION_FROM_CONTEXT_BODY(R.string.disable_offline_collection_from_context_body, R.string.disable_offline_collection_from_context_body_tracks),
