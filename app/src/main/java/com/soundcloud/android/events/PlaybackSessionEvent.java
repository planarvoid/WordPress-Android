...
public abstract class PlaybackSessionEvent extends NewTrackingEvent {
    ...
    private static PlaybackSessionEvent.Builder create(Kind eventKind, PlaybackSessionEventArgs args) {
        ...
        return new AutoValue_PlaybackSessionEvent.Builder().id(defaultId())
                                                           ...
                                                           .creatorUrn(args.getTrackData().getCreatorUrn())
                                                           .creatorName(args.getTrackData().getCreatorName())
                                                           .entityMetadata(entityMetadata)
                                                           .monetizationModel(args.getTrackData().getMonetizationModel())
                                                           .protocol(args.getProtocol())
                                                           .policy(Optional.fromNullable(args.getTrackData().getPolicy()))
