...
public class LeaveBehindImpressionEvent extends TrackingEvent {
    ...
    public LeaveBehindImpressionEvent(PropertySet adMetaData, Urn audioAdTrack, Urn userUrn, long timeStamp) {
        ...
        this.impressionUrls = adMetaData.get(LeaveBehindProperty.TRACKING_IMPRESSION_URLS);
    }
