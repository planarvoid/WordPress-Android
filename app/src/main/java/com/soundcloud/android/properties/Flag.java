...
public enum Flag {
    ...
    FEATURE_DISCOVERY(BuildConfig.FEATURE_DISCOVERY),
    FEATURE_DISCOVERY_RECOMMENDATIONS(BuildConfig.FEATURE_DISCOVERY_RECOMMENDATIONS),
    FEATURE_DISCOVERY_CHARTS(BuildConfig.FEATURE_DISCOVERY_CHARTS);
