...
public class TokenInformationGenerator {
    ...
    public Token getToken(Bundle data) throws ApiRequestException {
        return requestToken(getTokenParams(data));
    }

    public Token verifyScopes(String... scopes) throws ApiRequestException {
        Token token = requestToken(getScopeParams(scopes));
    ...
    private Map<String, String> getScopeParams(String[] scopes) {
        return oAuth.getTokenRequestParamsFromClientCredentials(scopes);
    }
