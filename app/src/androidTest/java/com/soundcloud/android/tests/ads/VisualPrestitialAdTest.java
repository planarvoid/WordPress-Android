...
public class VisualPrestitialAdTest extends ActivityTest<LauncherActivity> {
    ...
    protected void beforeStartActivity() {
        FeatureFlagsHelper.create(getInstrumentation().getTargetContext()).enable(Flag.DISPLAY_PRESTITIAL);
    }

    @Override
    protected void tearDown() throws Exception {
        FeatureFlagsHelper.create(getInstrumentation().getTargetContext()).reset(Flag.DISPLAY_PRESTITIAL);
        super.tearDown();
    }
