...
public class CollectionsPlaylistOptionsDialogElement extends Element {
    ...
    public CollectionsPlaylistOptionsDialogElement clickCreated() {
        testDriver.findOnScreenElement(text(testDriver.getString(R.string.collections_options_toggle_created))).click();
        return this;
    }

    public CollectionsPlaylistOptionsDialogElement clickLiked() {
        testDriver.findOnScreenElement(text(testDriver.getString(R.string.collections_options_toggle_likes))).click();
        return this;
    }
