...
public class DefaultStreamMeasurementTest extends AndroidUnitTest {

    @Mock private PerformanceMetricsEngine performanceMetricsEngine;

    @Captor private ArgumentCaptor<PerformanceMetric> performanceMetricArgumentCaptor;

    private DefaultStreamMeasurement defaultStreamMeasurement;

    @Before
    public void setUp() throws Exception {
        defaultStreamMeasurement = new DefaultStreamMeasurement(performanceMetricsEngine);
    }
