...
public class ReferrerResolverTest extends AndroidUnitTest {
    ...
    public void shouldDetectFacebookIntentViaAppId() throws Exception {
        ...
        assertThat(resolver.getReferrerFromIntent(intent, resources)).isEqualTo(Referrer.FACEBOOK.get());
    }
    ...
    public void shouldNotDetectFacebookIntentViaOtherAppIds() throws Exception {
        ...
        assertThat(resolver.getReferrerFromIntent(intent, resources)).isEqualTo(Referrer.OTHER.get());
    }
    ...
    public void shouldDetectOriginParameters() throws Exception {
        ...
        assertThat(resolver.getReferrerFromIntent(intent, resources)).isEqualTo(Referrer.MOBI.get());
    }
    ...
    public void shouldIgnoreCaseOfOrigin() throws Exception {
        ...
        assertThat(resolver.getReferrerFromIntent(intent, resources)).isEqualTo(Referrer.TWITTER.get());
    }
    ...
    public void shouldUseFallbackToIntentDataWhenOriginIsEmpty() throws Exception {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("soundcloud://sounds:1234?origin="));
        intent.putExtra("com.android.browser.application_id", "com.google.android.apps.plus");
        assertThat(resolver.getReferrerFromIntent(intent, resources)).isEqualTo(Referrer.GOOGLE_PLUS.get());
    }
    ...
    public void shouldDetectOtherReferrerAsDefault() throws Exception {
        assertThat(resolver.getReferrerFromIntent(new Intent(), resources)).isEqualTo(Referrer.OTHER.get());
    }
    ...
    public void shouldDetectGoogleCrawlerForReferrer() throws Exception {
        ...
        assertThat(resolver.getReferrerFromIntent(intent, resources)).isEqualTo(Referrer.GOOGLE_CRAWLER.get());
    }
    ...
    public void shouldDetectIntentReferrer() throws Exception {
        ...
        assertThat(resolver.getReferrerFromIntent(intent, resources)).isEqualTo(Referrer.APPBOY_NOTIFICATION.get());
    }
