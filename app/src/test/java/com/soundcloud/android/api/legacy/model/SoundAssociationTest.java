...
public class SoundAssociationTest {
    ...
    public void shouldProvideUniqueListItemId() throws Exception {
        ...
        soundAssociation1.playable = new PublicApiTrack(123l);
    ...
    public void testEquals() {
        SoundAssociation a1 = new SoundAssociation(new PublicApiTrack(1), new Date(), SoundAssociation.Type.TRACK);

        SoundAssociation a2;

        a2 = new SoundAssociation(new PublicApiTrack(1), new Date(), SoundAssociation.Type.TRACK);
        expect(a1).toEqual(a2);

        a2 = new SoundAssociation(new PublicApiTrack(2), new Date(), SoundAssociation.Type.TRACK);
    ...
    private void compareSoundItems(SoundAssociation soundItem, SoundAssociation soundItem2) {
        expect(soundItem2.getId()).toEqual(soundItem.getId());
