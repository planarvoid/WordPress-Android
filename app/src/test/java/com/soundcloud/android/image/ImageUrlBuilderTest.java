...
public class ImageUrlBuilderTest {
    ...
    public void shouldUseArtworkFromUrlTemplateIfAvailable() {
        when(imageResource.getArtworkUrlTemplate()).thenReturn(Optional.of(artworkTemplate));
    ...
    public void shouldUseResolveEndpointIfArtworkNotAvailable() {
        when(imageResource.getArtworkUrlTemplate()).thenReturn(Optional.<String>absent());
