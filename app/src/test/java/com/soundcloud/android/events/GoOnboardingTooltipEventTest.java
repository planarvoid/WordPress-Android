...
public class GoOnboardingTooltipEventTest {
    ...
    public void createsCollectionImpression() {
        ...
        assertThat(event.tooltipName().isPresent()).isFalse();
    ...
    public void createsListenOfflineLikesEvent() {
        ...
        assertThat(event.tooltipName().get()).isEqualTo("listen_offline_likes");
    ...
    public void createsListenOfflinePlaylistEvent() {
        ...
        assertThat(event.tooltipName().get()).isEqualTo("listen_offline_playlist");
    ...
    public void createsSearchGoPlusEvent() {
        ...
        assertThat(event.tooltipName().get()).isEqualTo("search_go_plus");
    ...
    public void createsOfflineSettingsEvent() {
        ...
        assertThat(event.tooltipName().get()).isEqualTo("offline_settings");
