...
public class AdPlaybackSessionEventTest extends AndroidUnitTest {
    ...
    public void shouldCreateEventFromFirstQuartileForAudioAd() {
        ...
        assertThat(progressEvent.get(EventLoggerTrackingKeys.KEY_QUARTILE_TYPE)).isEqualTo("ad::first_quartile");
        assertThat(progressEvent.get(EventLoggerTrackingKeys.KEY_MONETIZABLE_TRACK_URN)).isEqualTo(Urn.forTrack(123L).toString());
        assertThat(progressEvent.get(EventLoggerTrackingKeys.KEY_AD_URN)).isEqualTo(Urn.forAd("dfp", "869").toString());
        assertThat(progressEvent.get(EventLoggerTrackingKeys.KEY_MONETIZATION_TYPE)).isEqualTo("audio_ad");
    ...
    public void shouldCreateEventFromSecondQuartileForAudioAd() {
        ...
        assertThat(progressEvent.getKind()).isEqualTo("quartile_event");
        assertThat(progressEvent.get(EventLoggerTrackingKeys.KEY_QUARTILE_TYPE)).isEqualTo("ad::second_quartile");
        assertThat(progressEvent.get(EventLoggerTrackingKeys.KEY_MONETIZABLE_TRACK_URN)).isEqualTo(Urn.forTrack(123L).toString());
        assertThat(progressEvent.get(EventLoggerTrackingKeys.KEY_AD_URN)).isEqualTo(Urn.forAd("dfp", "869").toString());
        assertThat(progressEvent.get(EventLoggerTrackingKeys.KEY_MONETIZATION_TYPE)).isEqualTo("audio_ad");
    ...
    public void shouldCreateEventFromThirdQuartileForAudioAd() {
        ...
        assertThat(progressEvent.getKind()).isEqualTo("quartile_event");
        assertThat(progressEvent.get(EventLoggerTrackingKeys.KEY_QUARTILE_TYPE)).isEqualTo("ad::third_quartile");
        assertThat(progressEvent.get(EventLoggerTrackingKeys.KEY_MONETIZABLE_TRACK_URN)).isEqualTo(Urn.forTrack(123L).toString());
        assertThat(progressEvent.get(EventLoggerTrackingKeys.KEY_AD_URN)).isEqualTo(Urn.forAd("dfp", "869").toString());
        assertThat(progressEvent.get(EventLoggerTrackingKeys.KEY_MONETIZATION_TYPE)).isEqualTo("audio_ad");
    ...
    public void shouldCreateEventFromFirstQuartileForVideoAd() {
        ...
        assertThat(progressEvent.get(EventLoggerTrackingKeys.KEY_QUARTILE_TYPE)).isEqualTo("ad::first_quartile");
        assertThat(progressEvent.get(EventLoggerTrackingKeys.KEY_MONETIZABLE_TRACK_URN)).isEqualTo(Urn.forTrack(123L).toString());
        assertThat(progressEvent.get(EventLoggerTrackingKeys.KEY_AD_URN)).isEqualTo(Urn.forAd("dfp", "905").toString());
        assertThat(progressEvent.get(EventLoggerTrackingKeys.KEY_MONETIZATION_TYPE)).isEqualTo("video_ad");
    ...
    public void shouldCreateFromPlayEventWithImpressionAndStartUrlsForVideoAd() {
        ...
        assertThat(playEvent.get(EventLoggerTrackingKeys.KEY_MONETIZABLE_TRACK_URN)).isEqualTo(Urn.forTrack(123L).toString());
        assertThat(playEvent.get(EventLoggerTrackingKeys.KEY_AD_URN)).isEqualTo(Urn.forAd("dfp", "905").toString());
        assertThat(playEvent.get(EventLoggerTrackingKeys.KEY_MONETIZATION_TYPE)).isEqualTo("video_ad");
    ...
    public void shouldCreateFromStopEventWithFinishUrlsForVideoAd() {
        ...
        assertThat(stopEvent.get(EventLoggerTrackingKeys.KEY_MONETIZABLE_TRACK_URN)).isEqualTo(Urn.forTrack(123L).toString());
        assertThat(stopEvent.get(EventLoggerTrackingKeys.KEY_AD_URN)).isEqualTo(Urn.forAd("dfp", "905").toString());
        assertThat(stopEvent.get(EventLoggerTrackingKeys.KEY_MONETIZATION_TYPE)).isEqualTo("video_ad");
