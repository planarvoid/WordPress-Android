...
public class AdOverlayTrackingEventTest extends AndroidUnitTest {
    ...
    public void shouldCreateEventFromLeaveBehindImpression() {
        ...
        assertThat(uiEvent.get(EventLoggerTrackingKeys.KEY_AD_URN)).isEqualTo(leaveBehindAd.getAdUrn().toString());
        assertThat(uiEvent.get(EventLoggerTrackingKeys.KEY_MONETIZABLE_TRACK_URN)).isEqualTo(Urn.forTrack(456).toString());
        assertThat(uiEvent.get(EventLoggerTrackingKeys.KEY_AD_ARTWORK_URL)).isEqualTo(leaveBehindAd.getImageUrl());
        assertThat(uiEvent.get(EventLoggerTrackingKeys.KEY_CLICK_THROUGH_URL)).isEqualTo(leaveBehindAd.getClickthroughUrl().toString());
