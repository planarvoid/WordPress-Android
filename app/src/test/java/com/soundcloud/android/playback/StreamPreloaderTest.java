...
public class StreamPreloaderTest extends AndroidUnitTest {
    ...
    public void preloadsWhenConditionsMetOnMobileAndWithinProgressTolerance() {
        ...
        eventBus.publish(EventQueue.PLAYBACK_PROGRESS, new PlaybackProgressEvent(new PlaybackProgress(position, duration), Urn.NOT_SET));
    ...
    public void doesNotPreloadWhenNotPlaying() {
        ...
        eventBus.publish(EventQueue.PLAYBACK_PROGRESS, new PlaybackProgressEvent(PlaybackProgress.empty(), Urn.NOT_SET));
