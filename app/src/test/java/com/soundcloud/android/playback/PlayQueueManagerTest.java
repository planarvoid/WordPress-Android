...
public class PlayQueueManagerTest extends AndroidUnitTest {
    ...
    public void shouldReturnTrackSourceInfoWithoutReposterSetIfNotSet() {
        playQueueManager.setNewPlayQueue(TestPlayQueue.fromTracks(Arrays.asList(Urn.forTrack(1L).toPropertySet()),
    ...
    public void shouldReturnTrackSourceInfoWithReposterSetIfSet() {
        ...
        playQueueManager.setNewPlayQueue(TestPlayQueue.fromTracks(Arrays.asList(track), playlistSessionSource),
    ...
    public void getPlayableQueueItemsRemainingReturnsPlayableQueueItemsRemaining() {
        ...
        playQueueManager.setNewPlayQueue(PlayQueue.fromTrackUrnList(
                TestUrns.createTrackUrns(1L, 2L, 3L, 4L, 5L), playlistSessionSource, blockedMap),
                                         playlistSessionSource,
                                         1);
    ...
    public void insertMultipleUrnsAddsToQueue() {
        ...
        playQueueManager.insertNext(playlistUrns, playlistSessionSource);
    ...
    public void insertNextAddsToQueue() {
        ...
        playQueueManager.insertNext(nextTrackUrn, playlistSessionSource);
    ...
    public void insertNextSavesQueue() {
        ...
        playQueueManager.insertNext(Urn.forTrack(100L), playlistSessionSource);
    ...
    public void shouldThrowExceptionOnInsert1() {
        ...
        playQueueManager.insertNext(Urn.NOT_SET, playlistSessionSource);
    }

    @Test(expected = IllegalStateException.class)
    public void shouldThrowExceptionOnInsertMany() {
        playQueueManager.setNewPlayQueue(PlayQueue.empty(), PlaySessionSource.EMPTY);
        playQueueManager.insertNext(Lists.newArrayList(Urn.NOT_SET, Urn.NOT_SET), playlistSessionSource);
    }
