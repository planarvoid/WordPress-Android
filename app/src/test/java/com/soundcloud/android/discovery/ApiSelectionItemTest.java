...
public class ApiSelectionItemTest {
    ...
    static final ApiSelectionItem EXPECTED_PLAYLIST = ApiSelectionItem.create(URN, ARTWORK, ARTWORK_STYLE, TRACK_COUNT, SHORT_TITLE, SHORT_SUBTITLE, APP_LINK, WEB_LINK);
    static final String JSON = "{\"urn\": \"" + URN_VALUE + "\",\"artwork_url_template\": \"" + ARTWORK + "\",\"artwork_style\": \"" + ARTWORK_STYLE.toIdentifier() + "\",\"count\": " + TRACK_COUNT + ",\"short_title\": \"" + SHORT_TITLE + "\",\"short_subtitle\": \"" + SHORT_SUBTITLE + "\",\"app_link\": \"" + APP_LINK + "\",\"web_link\": \"" + WEB_LINK + "\"}";
