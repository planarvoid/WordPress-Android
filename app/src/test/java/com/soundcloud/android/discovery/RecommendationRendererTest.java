...
import static com.soundcloud.android.discovery.RecommendationsFixtures.createHighTierRecommendation;
import static com.soundcloud.android.discovery.RecommendationsFixtures.createNonHighTierRecommendation;
...
public class RecommendationRendererTest extends AndroidUnitTest {
    ...
    public void setUp() {
        ...
        final Recommendation recommendation = createNonHighTierRecommendation(SEED_TRACK.getUrn());
        recommendedTrack = recommendation.getTrack();
        final Recommendation goRecommendation = createHighTierRecommendation(SEED_TRACK.getUrn());
