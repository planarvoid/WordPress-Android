...
public class AccountCleanupActionTest extends AndroidUnitTest {
    ...
    @Mock private RemoveRecommendationsCommand removeRecommendationsCommand;
    ...
    public void setup() {
        action = new AccountCleanupAction(syncStateManager,
                ...
                removeLocalPlaylistsCommand, removeRecommendationsCommand, clearTableCommand, stationsOperations);
    ...
    public void shouldRemoveRecommendations() throws PropellerWriteException {
        action.call();
        verify(removeRecommendationsCommand).call(null);
    }
