...
public class OfflineTracksCollectionStateOperationsTest extends AndroidUnitTest {
    private static final Urn TRACK1 = Urn.forTrack(123L);
    private static final Urn TRACK2 = Urn.forTrack(456L);
    private static final Urn PLAYLIST = Urn.forPlaylist(123L);

    private OfflineTracksCollectionStateOperations operations;
    ...
    public void setUp() throws Exception {
        operations = new OfflineTracksCollectionStateOperations(
