...
public class LegacyPlaylistEngagementsPresenterTest extends AndroidUnitTest {
    ...
    public void setup() {
        ...
        controller = new LegacyPlaylistEngagementsPresenter(eventBus,
                                                            repostOperations,
                                                            accountOperations,
                                                            likeOperations,
                                                            engagementsView,
    ...
    public void showsOfflineAvailableWhenOfflineContentIsEnabledAndPlaylistCurrentlyMarkedAvailable() {
        ...
        controller.setPlaylistInfo(PlaylistHeaderItem.create(createPlaylistWithTracks(sourceSet),
                                                             getPlaySessionSource()));
    ...
    public void disablesShuffleWithOneTrack() throws Exception {
        ...
        controller.setPlaylistInfo(PlaylistHeaderItem.create(createPlaylistWithSingleTrack(sourceSet),
                                                             getPlaySessionSource()));
