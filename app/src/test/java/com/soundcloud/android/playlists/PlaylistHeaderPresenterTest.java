...
public class PlaylistHeaderPresenterTest extends AndroidUnitTest {
    ...
    private PlaylistHeaderPresenter controller;
    ...
    public void setup() {
        ...
        controller = new PlaylistHeaderPresenter(
                repostOperations,
                accountOperations,
                eventBus,
                likeOperations,
                ...
                connectionHelper,
                offlineSettings,
                playlistDetailsViewFactory);

        when(playlistDetailsViewFactory.create(any(View.class), any(View.OnClickListener.class), any(View.OnClickListener.class))).thenReturn(playlistDetailsView);
