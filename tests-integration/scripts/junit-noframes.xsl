...
<xsl:template name="JS-escape">
    ...
    <xsl:param name="tmp1" select="translate(string($string),'\','\\')"/>
    <xsl:param name="tmp2" select="translate(string($tmp1), &quot;'&quot;, &quot;\&apos;&quot;)"/>
    <xsl:param name="tmp3" select="translate(string($tmp2), '&#13;', '')"/>
    <xsl:param name="tmp4" select="translate(string($tmp3), '&#10;', '')"/>
...
<xsl:template name="br-replace">
    <xsl:param name="word"/>
    <xsl:value-of disable-output-escaping="yes" select='translate(string($word),"&#xA;","&lt;br/>")'/>
</xsl:template>
