...
public class ViolationCommentsTask extends DefaultTask {
    ...
    public void gitChangelogPluginTasks() throws TaskExecutionException {
        ...
        List<Violation> filteredViolations = filterChanged(allParsedViolations, commentsProvider);
    ...
    private List<Violation> filterChanged(List<Violation> allViolations, CommentsProvider commentsProvider) {
        List<Violation> isChanged = new ArrayList<>();
        for (Violation violation : allViolations) {
            Optional<ChangedFile> file = getFile(violation, commentsProvider.getFiles());
            if (file.isPresent()) {
    ...
    private Optional<ChangedFile> getFile(Violation violation, List<ChangedFile> files) {
