...
class LoadCommentsTask extends AsyncTask<String, Parcelable, Boolean> {
	...
	protected Boolean doInBackground(String... params) {
		...
		String mBaseUrl = CloudUtils.buildRequestPath(CloudCommunicator.PATH_TRACK_COMMENTS.replace("{track_id}",track_id), null, null).toString();
