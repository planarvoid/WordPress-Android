	...
	public void handleException() {
		...
		if (getException() != null) {
			if (getException() instanceof UnknownHostException 
				...
				//don't show general errors : showDialog(CloudUtils.Dialogs.DIALOG_GENERAL_ERROR);
			}
		}
		setException(null);
	}
		...
		protected Dialog onCreateDialog(int which) {
			switch (which) {
				...
				case CloudUtils.Dialogs.DIALOG_UNAUTHORIZED:
					return new AlertDialog.Builder(this).setTitle(R.string.error_unauthorized_title).setMessage(R.string.error_unauthorized_message).setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog, int which) {
				...
				case CloudUtils.Dialogs.DIALOG_ERROR_RECORDING:
					return new AlertDialog.Builder(this)
					.setTitle(R.string.error_recording_title)
					.setMessage(R.string.error_recording_message)
					.setPositiveButton(R.string.btn_ok, new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog, int which) {
