...
public class CommentsAdapter extends LazyExpandableBaseAdapter {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View row,
        ...
        rowView.display(mChildData.get(groupPosition).get(childPosition),
                (mSelectedGroupIndex == groupPosition && mSelectedChildIndex == childPosition));
    ...
    public class CommentRow extends LazyRow {
        ...
        public String getIconRemoteUri() {
            // if (getContext().getResources().getDisplayMetrics().density > 1){
            // return
            // CloudUtils.formatGraphicsUrl(mComment.getData(Comment.key_user_avatar_url),GraphicsSizes.large);
            // } else
            // return
            // CloudUtils.formatGraphicsUrl(mComment.getData(Comment.key_user_avatar_url),GraphicsSizes.badge);
            return "";
        }
        ...
        protected String getUsernameString() {
            ...
            // mComment.getData(Comment.key_timestamp_formatted);
            return "";
        }
