...
public class WavEncoderTask extends AsyncTask<String, Integer, Boolean> {
    ...
    protected Boolean doInBackground(String... params) {
        ...
        if (params.length < 2) {
            System.out
                    .println("Incorrect number of parameters. Input file and output file required");
            return false;
        }
        ...
        try {
            ...
            try {
                ...
                WaveHeader hdr = new WaveHeader(WaveHeader.FORMAT_PCM, (short) 2, 44100,
                        (short) 16, musicLength * 2);
                hdr.write(out);
