...
- [ ] push translations to Transifex (tx push -t) before Monday 11am CEST (see [Transifex instructions](https://github.com/soundcloud/SoundCloud-Android/wiki/Transifex))
