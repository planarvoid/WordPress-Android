...
@Implements(android.content.SharedPreferences.class)
public class ScTestSharedPreferences implements SharedPreferences {
    ...
    public ScTestSharedPreferences() {
        this(new HashMap<String, Map<String, Object>>(), "__default__", Context.MODE_PRIVATE);
    }

    public ScTestSharedPreferences(Map<String, Map<String, Object>> content,
        ...
        public boolean commit() {
            ...
            for (OnSharedPreferenceChangeListener listener : listeners) {
                for (String key : keysToPassToListeners) {
                    listener.onSharedPreferenceChanged(ScTestSharedPreferences.this, key);
                }
            }
