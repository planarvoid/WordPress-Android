...
module Build
  class RakeHelper
    ...
    def tasks
      ...
      namespace :repack do
        desc "Roll your own Guava!"
        task :guava do
          guava_pg_options = [
            '-keep class com.google.common.annotations.VisibleForTesting',
            '-keep class com.google.common.net.HttpHeaders { *; }'
          ]
          repack_artifact "com.google.common", "com.google.guava", "guava", guava_pg_options
        end
      end
    end

    def repack_artifact(base_package, group_id, artifact_id, pg_options = [])
