...
# New Profile
Adding this section till we have complete automation coverage for the new profile pages.
Ensure `FeatureProfileNewTab` feature toggle is enabled for testing.
- [ ] Own Profile
