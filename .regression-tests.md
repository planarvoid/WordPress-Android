...
4. You should see requests to [b.scorecardresearch.com] and [e.crashlytics.com]
5. Switch off Analytics and Crashlogs
6. Restart the app
7. You shouldn't see requests from [b.scorecardresearch.com] and [e.crashlytics.com]
...
Some things have to tested manually (release branch devDebug), using a free-tier user that has items in the stream please check that:
