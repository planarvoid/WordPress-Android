 ...
 * Original file: /Users/jschmidt/Desktop/dev/sc_workspace/Soundcloud/src/com/soundcloud/android/ICloudPlaybackService.aidl
 */
package com.soundcloud.android;
public interface ICloudPlaybackService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.soundcloud.android.ICloudPlaybackService
{
private static final java.lang.String DESCRIPTOR = "com.soundcloud.android.ICloudPlaybackService";
...
/**
 * Cast an IBinder object into an com.soundcloud.android.ICloudPlaybackService interface,
 * generating a proxy if needed.
 */
public static com.soundcloud.android.ICloudPlaybackService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = (android.os.IInterface)obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.soundcloud.android.ICloudPlaybackService))) {
return ((com.soundcloud.android.ICloudPlaybackService)iin);
}
return new com.soundcloud.android.ICloudPlaybackService.Stub.Proxy(obj);
}
...
private static class Proxy implements com.soundcloud.android.ICloudPlaybackService
{
...
static final int TRANSACTION_setComments = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_addComment = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_setFavoriteStatus = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_getQueue = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_moveQueueItem = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
...
static final int TRANSACTION_getDuration = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_getDownloadable = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
...
static final int TRANSACTION_setRepeatMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_getRepeatMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_getMediaMountedCount = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
}
public void openFile(com.soundcloud.android.objects.Track track, boolean oneShot) throws android.os.RemoteException;
public void enqueueTrack(com.soundcloud.android.objects.Track track, int action) throws android.os.RemoteException;
public void enqueue(com.soundcloud.android.objects.Track[] trackData, int playPos) throws android.os.RemoteException;
