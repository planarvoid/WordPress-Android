...
public class LoginEmailFragment extends LoginBaseFormFragment<LoginListener>
    ...
    private LoginGoogleAuthFragment mGoogleAuthFragment;
    ...
    protected void setupContent(ViewGroup rootView) {
        ...
        googleLoginButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mGoogleAuthFragment.startLoginProcess();
            }
        });
    }
    ...
    protected void onHelp() {
        if (mLoginListener != null) {
            if (mGoogleAuthFragment != null) {
                mGoogleAuthFragment.onHelp();
            } else {
    ...
    private LoginGoogleAuthFragment addGoogleAuthFragment() {
        LoginGoogleAuthFragment loginGoogleAuthFragment;
        FragmentManager fm = getChildFragmentManager();
        loginGoogleAuthFragment = (LoginGoogleAuthFragment) fm.findFragmentByTag(LoginGoogleAuthFragment.TAG);

        if (loginGoogleAuthFragment == null) {
            loginGoogleAuthFragment = new LoginGoogleAuthFragment();
            FragmentTransaction t = fm.beginTransaction();
            t.add(loginGoogleAuthFragment, LoginGoogleAuthFragment.TAG);
            t.commit();
        }


        return loginGoogleAuthFragment;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mGoogleAuthFragment = addGoogleAuthFragment();
    }
